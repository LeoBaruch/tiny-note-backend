use axum::{Router, Json, response::IntoResponse, http::{StatusCode, Method}};
use serde_json::json;
...
pub fn build_router(state: &AppState) -> Router {
    ...
    let notes_routes = notes::router().route_layer(axum::middleware::from_fn_with_state(state.clone(), crate::app_middleware::auth_middleware::require_auth));
    ...
    Router::new()
        ...
        .layer(axum::middleware::from_fn(crate::middleware::logging::request_logger))
        .layer(cors)
